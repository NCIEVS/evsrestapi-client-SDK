...
public class SearchTests {
  ...
  public void testFindConceptsBySearchTerm() throws Exception {
    final ConceptResultList list = client.findConceptsBySearchTerm(terminology, "melanoma", "5",
  ...
  public void testFindConceptsBySearchTermConceptStatus() throws Exception {
    final ConceptResultList list = client.findConceptsBySearchTerm(terminology, "respiratory", "5",
  ...
  public void testFindConceptsBySearchTermContributingSource() throws Exception {
    final ConceptResultList list = client.findConceptsBySearchTerm(terminology, "melanoma", "5",
        null, "CDISC", null, null, null, null, null, null);
  ...
  public void testFindConceptsBySearchTermDefinitionSource() throws Exception {
    final ConceptResultList list = client.findConceptsBySearchTerm(terminology, "melanoma", "5",
        null, null, "NCI", null, null, null, null, null);
  ...
  public void testFindConceptsBySearchTermSynonymSource() throws Exception {
    final ConceptResultList list = client.findConceptsBySearchTerm(terminology, "dsDNA", null, null,
  ...
  public void testFindConceptsBySearchTermAsCode() throws Exception {
    final ConceptResultList list = client.findConceptsBySearchTerm(terminology, "C3224", null, null,
  ...
  public void testFindConceptsBySearchTermMatch() throws Exception {
    final ConceptResultList list = client.findConceptsBySearchTerm(terminology, "enzyme", "5", null,
  ...
  public void testFindConceptsBySearchTermPhrase() throws Exception {
    final ConceptResultList list = client.findConceptsBySearchTerm(terminology,
        "malignant melanoma", "5", null, null, null, null, null, "phrase", null, null);
  ...
  public void testFindConceptsBySearchTermAnd() throws Exception {
    final ConceptResultList list = client.findConceptsBySearchTerm(terminology,
        "malignant melanoma", "5", null, null, null, null, null, "AND", null, null);
  ...
  public void testFindConceptsBySearchTermOr() throws Exception {
    final ConceptResultList list = client.findConceptsBySearchTerm(terminology,
        "malignant melanoma", "5", null, null, null, null, null, "OR", null, null);
  ...
  public void testFindConceptsByProperty() throws Exception {
    ...
    final ConceptResultList list = client.findConceptsBySearchTerm(terminology, "XAV05295I5", null,
        null, null, null, null, null, null, "fda_unii_code", includes);
