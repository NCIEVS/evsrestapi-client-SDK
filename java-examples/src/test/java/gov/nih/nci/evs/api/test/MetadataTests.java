...
public class MetadataTests {
  ...
  public void testGetQualifierValues() throws Exception {
    ...
    final List<String> list = client.getQualifierValues(terminology, "P390");
    logger.info("Get qualifier values for - P390");
    logger.info("  base url = " + client.getApiUrl());
  ...
  public void testGetDefinitionTypes() throws Exception {
    ...
    final List<Concept> list = client.getDefinitionTypeInfo(terminology, "definitionTypes");
  ...
  public void testGetSynonymTypes() throws Exception {
    ...
    final List<Concept> list = client.getSynonymTypeInfo(terminology, "synonymTypes");
  ...
  public void testGetAllSubsets() throws Exception {
    ...
    final List<Concept> list = client.getAllSubsets(terminology);
    logger.info("Get all subsets - " + terminology);
    logger.info("  base url = " + client.getApiUrl());
    logger.info("  subsets = " + list);
  }

  /**
   * Test get subset by code.
   *
   * @throws Exception the exception
   */
  @Test
  public void testGetSubsetByCode() throws Exception {

    final Concept subset = client.getSubsetByCode(terminology, "C81222", "summary");
    logger.info("Get subset - " + terminology + ", C81222");
    logger.info("  base url = " + client.getApiUrl());
  ...
  public void testGetSubsetMembersByCode() throws Exception {
    ...
    final List<Concept> list = client.getSubsetMembersByCode(terminology, "C81222", 0, 10);
    logger.info("Get all subset members - " + terminology + ", C81222");
    logger.info("  base url = " + client.getApiUrl());
    logger.info("  subset members = " + list);
  }
   ...
   */
  @Test
  public void testGetWelcomeText() throws Exception {
    final String welcomeText = client.getWelcomeText("ncit");
    logger.info("Get welcome text");
    logger.info("  base url = " + client.getApiUrl());
    logger.info(" ncit welcome text = " + welcomeText);
  }
