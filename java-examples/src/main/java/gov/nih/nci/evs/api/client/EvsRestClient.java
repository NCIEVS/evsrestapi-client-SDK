...
public class EvsRestClient extends RootClient {
   ...
   * @throws Exception the exception
   */
  public List<Concept> getProperties(final String terminology, final String include, final List<String> codes)
      throws Exception {
   ...
   * @throws Exception the exception
   */
  public List<Concept> getQualifiers(final String terminology, final String include, final List<String> codes)
      throws Exception {
   ...
   * @throws Exception the exception
   */
  public List<String> getQualifierValues(final String terminology, final String code) throws Exception {
   ...
   * @throws Exception the exception
   */
  public List<Concept> getRoles(final String terminology, final String include, final List<String> codes)
      throws Exception {
   ...
   * @throws Exception the exception
   */
  public List<Concept> getAssociations(final String terminology, final String include, final List<String> codes)
      throws Exception {
   ...
   * @throws Exception the exception
   */
  public List<HierarchyNode> getSubtree(final String terminology, final String code) throws Exception {
   ...
   * @throws Exception the exception
   */
  public List<HierarchyNode> getSubtreeChildren(final String terminology, final String code) throws Exception {
  ...
  public ConceptResultList findConceptsBySearchTerm(final String terminology, final String term,
    ...
    return getConceptBySearchTermHelper(terminology, term, pageSize, conceptStatus, contributingSource,
        definitionSource, synonymSource, synonymTermGroup, type, property, includes);
  }
   ...
   * @throws Exception the exception
   */
  private List<Concept> getAllMetadataHelper(final String type, final String terminology, final String include,
    ...
    final Client client = getClients().get();
    final WebTarget target = client.target(getApiUrl() + "/metadata/" + terminology + "/" + type + params);
    try (Response response = request(target).get()) {
      if (response.getStatusInfo().getFamily() != Family.SUCCESSFUL) {
   ...
   * @throws Exception the exception
   */
  public Concept getProperty(final String terminology, final String codeOrLabel, final String include)
      throws Exception {
   ...
   * @throws Exception the exception
   */
  public Concept getQualifier(final String terminology, final String codeOrLabel, final String include)
      throws Exception {
   ...
   * @throws Exception the exception
   */
  public Concept getRole(final String terminology, final String codeOrLabel, final String include) throws Exception {
   ...
   * @throws Exception the exception
   */
  public Concept getAssociation(final String terminology, final String codeOrLabel, final String include)
      throws Exception {
   ...
   * @throws Exception the exception
   */
  public Concept getConcept(final String terminology, final String code, final String include) throws Exception {
   ...
   * @throws Exception the exception
   */
  public List<Map> getMapPart(final String terminology, final String code, final String part) throws Exception {
   ...
   * @throws Exception the exception
   */
  public List<Concept> getConcepts(final String terminology, final List<String> codes, final String include)
      throws Exception {
   ...
   * @throws Exception the exception
   */
  public List<List<Concept>> getConceptPath(final String terminology, final String code, final String part1,
      final String part2) throws Exception {
   ...
   * @throws Exception the exception
   */
  private Concept getHelper(final String type, final String terminology, final String code, final String include)
      throws Exception {
   ...
   * @throws Exception the exception
   */
  private List<Concept> getConceptPartHelper(final String terminology, final String code, final String part)
      throws Exception {
   ...
   * @throws Exception the exception
   */
  private List<Relationship> getRelationshipPartHelper(final String terminology, final String code, final String part)
      throws Exception {
   ...
   * @throws Exception the exception
   */
  private List<Concept> getListHelper(final String type, final String terminology, final List<String> codes,
    ...
    try (Response response = request(target).get()) {
      if (response.getStatusInfo().getFamily() != Family.SUCCESSFUL) {
        logger.error("Unexpected error getting " + type + " = " + terminology + ", " + String.join(";", codes));
        throw new WebApplicationException(response.readEntity(String.class), response.getStatus());
      }
      final String json = response.readEntity(String.class);
      return getMapper().readValue(json, new TypeReference<List<Concept>>() {
   ...
   * @throws Exception the exception
   */
  private List<List<Concept>> getConceptPathHelper(final String terminology, final String code, final String part1,
      final String part2) throws Exception {
  ...
  public List<Concept> getAllSubsets(final String terminology) throws Exception {
    ...
    try (Response response = request(target).get()) {
      if (response.getStatusInfo().getFamily() != Family.SUCCESSFUL) {
        logger.error("Unexpected error getting subsets for " + terminology);
        throw new WebApplicationException(response.readEntity(String.class), response.getStatus());
      }
      final String json = response.readEntity(String.class);
      return getMapper().readValue(json, new TypeReference<List<Concept>>() {
  ...
  public String getWelcomeText(String terminology) throws Exception {
    final Client client = getClients().get();
    final WebTarget target = client.target(getApiUrl() + "/metadata/" + terminology + "/welcomeText");
    try (Response response = request(target).get()) {
      if (response.getStatusInfo().getFamily() != Family.SUCCESSFUL) {
        logger.error("Unexpected error getting terminologies");
        throw new WebApplicationException(response.readEntity(String.class), response.getStatus());
