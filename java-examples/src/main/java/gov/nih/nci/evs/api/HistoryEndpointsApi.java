...
public class HistoryEndpointsApi {
     ...
     * </table>
     */
    public okhttp3.Call getReplacementsCall(String terminology, String code, final ApiCallback _callback)
            throws ApiException {
        ...
        String localVarPath = "/api/v1/history/{terminology}/{code}/replacements".replace("{" + "terminology" + "}",
                                                                                          localVarApiClient.escapeString(
                                                                                                  terminology.toString()))
                                                                                 .replace("{" + "code" + "}",
                                                                                          localVarApiClient.escapeString(
                                                                                                  code.toString()));
    ...
    private okhttp3.Call getReplacementsValidateBeforeCall(String terminology, String code, final ApiCallback _callback)
            throws ApiException {
    ...
    public ApiResponse<List<History>> getReplacementsWithHttpInfo(String terminology, String code) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<History>>() {
        }.getType();
     ...
     * </table>
     */
    public okhttp3.Call getReplacementsAsync(String terminology, String code,
                                             final ApiCallback<List<History>> _callback) throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call getReplacementsFromListCall(String terminology, String _list, final ApiCallback _callback)
            throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[]{};
        ...
        Object localVarPostBody = null;
        // create path and map variables
        String localVarPath = "/api/v1/history/{terminology}/replacements".replace("{" + "terminology" + "}",
                                                                                   localVarApiClient.escapeString(
                                                                                           terminology.toString()));
        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getReplacementsFromListValidateBeforeCall(String terminology, String _list,
                                                                   final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'terminology' is set
        if (terminology == null) {
            throw new ApiException(
                    "Missing the required parameter 'terminology' when calling getReplacementsFromList(Async)");
        }
        // verify the required parameter '_list' is set
        if (_list == null) {
            throw new ApiException(
                    "Missing the required parameter '_list' when calling getReplacementsFromList(Async)");
        }
     ...
     * </table>
     */
    public ApiResponse<List<History>> getReplacementsFromListWithHttpInfo(String terminology, String _list)
            throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call getReplacementsFromListAsync(String terminology, String _list,
                                                     final ApiCallback<List<History>> _callback) throws ApiException {
