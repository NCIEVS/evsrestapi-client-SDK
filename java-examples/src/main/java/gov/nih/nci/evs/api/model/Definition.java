 ...
 */
@JsonPropertyOrder({
  Definition.JSON_PROPERTY_URI,
  Definition.JSON_PROPERTY_CT,
  Definition.JSON_PROPERTY_DEFINITION,
  Definition.JSON_PROPERTY_HIGHLIGHT,
  Definition.JSON_PROPERTY_CODE,
  Definition.JSON_PROPERTY_TYPE,
  Definition.JSON_PROPERTY_SOURCE,
  Definition.JSON_PROPERTY_QUALIFIERS
})
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getDefinition() != null) {
      joiner.add(String.format("%sdefinition%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDefinition()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
