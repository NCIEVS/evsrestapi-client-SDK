 ...
 */
@JsonPropertyOrder({
  Synonym.JSON_PROPERTY_URI,
  Synonym.JSON_PROPERTY_CT,
  Synonym.JSON_PROPERTY_NAME,
  Synonym.JSON_PROPERTY_HIGHLIGHT,
  Synonym.JSON_PROPERTY_TERM_TYPE,
  Synonym.JSON_PROPERTY_TYPE,
  Synonym.JSON_PROPERTY_TYPE_CODE,
  Synonym.JSON_PROPERTY_SOURCE,
  Synonym.JSON_PROPERTY_CODE,
  Synonym.JSON_PROPERTY_SUB_SOURCE,
  Synonym.JSON_PROPERTY_QUALIFIERS,
  Synonym.JSON_PROPERTY_ACTIVE
})
...
public class Synonym {
  ...
  public static final String JSON_PROPERTY_SUB_SOURCE = "subSource";
  ...
  **/
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_SUB_SOURCE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  **/
  ...
  /**
   * Return true if this Synonym object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `typeCode` to the URL query string
    if (getTypeCode() != null) {
      joiner.add(String.format("%stypeCode%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTypeCode()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    // add `subSource` to the URL query string
    if (getSubSource() != null) {
      joiner.add(String.format("%ssubSource%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getSubSource()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
