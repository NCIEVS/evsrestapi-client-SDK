...
public class MetadataEndpointsApi {
    ...
    /**
     * Build call for getOverviewMetadata
     * @param terminology Terminology, e.g. &#39;ncit&#39; or &#39;ncim&#39; (&lt;a href&#x3D;\&quot;https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/TERMINOLOGIES.md\&quot;&gt;See here for complete list&lt;/a&gt;) (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getOverviewMetadataCall(String terminology, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getOverviewMetadataValidateBeforeCall(String terminology, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'terminology' is set
        if (terminology == null) {
            throw new ApiException("Missing the required parameter 'terminology' when calling getOverviewMetadata(Async)");
        }

        return getOverviewMetadataCall(terminology, _callback);
    ...
    public Map<String, List<Concept>> getOverviewMetadata(String terminology) throws ApiException {
        ApiResponse<Map<String, List<Concept>>> localVarResp = getOverviewMetadataWithHttpInfo(terminology);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<Map<String, List<Concept>>> getOverviewMetadataWithHttpInfo(String terminology) throws ApiException {
        okhttp3.Call localVarCall = getOverviewMetadataValidateBeforeCall(terminology, null);
        Type localVarReturnType = new TypeToken<Map<String, List<Concept>>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get some metadata (associations, properties, qualifiers, roles, term types, sources, definition types, synonym types) for the terminology overview tab in EVS-Explore (asynchronously)
     * 
     * @param terminology Terminology, e.g. &#39;ncit&#39; or &#39;ncim&#39; (&lt;a href&#x3D;\&quot;https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/TERMINOLOGIES.md\&quot;&gt;See here for complete list&lt;/a&gt;) (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getOverviewMetadataAsync(String terminology, final ApiCallback<Map<String, List<Concept>>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getOverviewMetadataValidateBeforeCall(terminology, _callback);
        Type localVarReturnType = new TypeToken<Map<String, List<Concept>>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param terminology Terminology, e.g. &#39;ncit&#39; or &#39;ncim&#39; (&lt;a href&#x3D;\&quot;https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/TERMINOLOGIES.md\&quot;&gt;See here for complete list&lt;/a&gt;) (required)
     * @param codeOrName Property code (or name), e.g.&lt;ul&gt;&lt;li&gt;&#39;P216&#39; or &#39;BioCarta_ID&#39; for &lt;i&gt;ncit&lt;/i&gt;&lt;/li&gt;&lt;li&gt;&#39;Semantic_Type&#39; for &lt;i&gt;ncim&lt;/i&gt;&lt;/li&gt;&lt;/ul&gt; (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getPropertyValuesCall(String terminology, String codeOrName, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPropertyValuesValidateBeforeCall(String terminology, String codeOrName, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'terminology' is set
        if (terminology == null) {
            throw new ApiException("Missing the required parameter 'terminology' when calling getPropertyValues(Async)");
        }

        // verify the required parameter 'codeOrName' is set
        if (codeOrName == null) {
            throw new ApiException("Missing the required parameter 'codeOrName' when calling getPropertyValues(Async)");
        }

        return getPropertyValuesCall(terminology, codeOrName, _callback);
    ...
    public List<String> getPropertyValues(String terminology, String codeOrName) throws ApiException {
        ApiResponse<List<String>> localVarResp = getPropertyValuesWithHttpInfo(terminology, codeOrName);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<List<String>> getPropertyValuesWithHttpInfo(String terminology, String codeOrName) throws ApiException {
        okhttp3.Call localVarCall = getPropertyValuesValidateBeforeCall(terminology, codeOrName, null);
        Type localVarReturnType = new TypeToken<List<String>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get property values for the specified terminology and code/name (asynchronously)
     * 
     * @param terminology Terminology, e.g. &#39;ncit&#39; or &#39;ncim&#39; (&lt;a href&#x3D;\&quot;https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/TERMINOLOGIES.md\&quot;&gt;See here for complete list&lt;/a&gt;) (required)
     * @param codeOrName Property code (or name), e.g.&lt;ul&gt;&lt;li&gt;&#39;P216&#39; or &#39;BioCarta_ID&#39; for &lt;i&gt;ncit&lt;/i&gt;&lt;/li&gt;&lt;li&gt;&#39;Semantic_Type&#39; for &lt;i&gt;ncim&lt;/i&gt;&lt;/li&gt;&lt;/ul&gt; (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getPropertyValuesAsync(String terminology, String codeOrName, final ApiCallback<List<String>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getPropertyValuesValidateBeforeCall(terminology, codeOrName, _callback);
        Type localVarReturnType = new TypeToken<List<String>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Get statistics for the source within the specified terminology. (asynchronously)
     * This endpoint is mostly for NCIm to make source overlap statistics available.
     * @param terminology Terminology, e.g. &#39;ncit&#39;. (required)
     * @param source terminology source code, e.g. &#39;LNC&#39; for &lt;i&gt;ncim&lt;/i&gt;. (required)
     * @param _callback The callback to be executed when the API call finishes
