...
public class MapsetEndpointsApi {
   ...
   * @param include Indicator of how much data to return. Comma-separated list of any of the
   *     following values: minimal, summary, full, associations, children, definitions,
   *     disjointWith, inverseAssociations, inverseRoles, maps, parents, properties, roles,
   *     synonyms. &lt;a
   *     href&#x3D;&#39;https://github.com/NCIEVS/evsrestapi-client-SDK/blob/master/doc/INCLUDE.md&#39;
   *     target&#x3D;&#39;_blank&#39;&gt;See here for detailed information&lt;/a&gt;. (optional)
   ...
   * </table>
   */
  public okhttp3.Call getMapsetByCodeCall(String code, String include, final ApiCallback _callback)
      throws ApiException {
  ...
  private okhttp3.Call getMapsetByCodeValidateBeforeCall(
      String code, String include, final ApiCallback _callback) throws ApiException {
    // verify the required parameter 'code' is set
    if (code == null) {
      throw new ApiException(
          "Missing the required parameter 'code' when calling getMapsetByCode(Async)");
    }
   ...
   * </table>
   */
  public ApiResponse<Concept> getMapsetByCodeWithHttpInfo(String code, String include)
      throws ApiException {
  ...
  /**
   * Get the mapset for the specified code (no terminology parameter is needed as mapsets connect
   * codes in one terminology to another) (asynchronously)
   *
   * @param code Mapset code (required)
   * @param include Indicator of how much data to return. Comma-separated list of any of the
   *     following values: minimal, summary, full, associations, children, definitions,
   ...
   * </table>
   */
  public okhttp3.Call getMapsetByCodeAsync(
      String code, String include, final ApiCallback<Concept> _callback) throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call getMapsetMappingsByCodeCall(
      String code,
      Integer fromRecord,
      Integer pageSize,
      String term,
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call getMapsetMappingsByCodeValidateBeforeCall(
      String code,
      Integer fromRecord,
      Integer pageSize,
      String term,
    ...
    if (code == null) {
      throw new ApiException(
          "Missing the required parameter 'code' when calling getMapsetMappingsByCode(Async)");
    }

    return getMapsetMappingsByCodeCall(
        code, fromRecord, pageSize, term, ascending, sort, _callback);
  }

  /**
   * Get the maps for the mapset specified by the code (no terminology parameter is needed as
   ...
   * </table>
   */
  public MapResultList getMapsetMappingsByCode(
      String code,
      Integer fromRecord,
      Integer pageSize,
      String term,
      ...
      String sort)
      throws ApiException {
    ApiResponse<MapResultList> localVarResp =
        getMapsetMappingsByCodeWithHttpInfo(code, fromRecord, pageSize, term, ascending, sort);
    return localVarResp.getData();
  }
   ...
   * </table>
   */
  public ApiResponse<MapResultList> getMapsetMappingsByCodeWithHttpInfo(
      String code,
      Integer fromRecord,
      Integer pageSize,
      String term,
    ...
    okhttp3.Call localVarCall =
        getMapsetMappingsByCodeValidateBeforeCall(
            code, fromRecord, pageSize, term, ascending, sort, null);
  ...
  /**
   * Get the maps for the mapset specified by the code (no terminology parameter is needed as
   * mapsets connect codes in one terminology to another) (asynchronously)
   *
   * @param code Mapset code (required)
   * @param fromRecord Start index of the search results (optional)
   * @param pageSize Max number of results to return (optional)
   ...
   * </table>
   */
  public okhttp3.Call getMapsetMappingsByCodeAsync(
      String code,
      Integer fromRecord,
      Integer pageSize,
      String term,
      Boolean ascending,
      String sort,
      final ApiCallback<MapResultList> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call getMapsetsCall(String include, final ApiCallback _callback)
      throws ApiException {
    String basePath = null;
    // Operation Servers
    String[] localBasePaths = new String[] {};
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call getMapsetsValidateBeforeCall(String include, final ApiCallback _callback)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call getMapsetsAsync(String include, final ApiCallback<List<Concept>> _callback)
      throws ApiException {
