...
class ConceptMapResultList(BaseModel):
    """
    ...
    maps: Optional[List[ConceptMap]] = Field(default=None, description="List of maps")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConceptMapResultList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConceptMapResultList from a dict"""
        if obj is None:
            return None
