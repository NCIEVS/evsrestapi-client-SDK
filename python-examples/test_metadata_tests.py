...
def test_get_all_terminologies():
...
# Return property for the specified code or label. This examples includes a summary for the specified code.
def test_get_property_by_code_or_label():
...
# Return qualifier for the specified code or label. This examples includes a summary for the specified code.
def test_get_qualifier_by_code():
...
def test_get_qualifier_values_by_code():
...
# Return associations by code.
def test_get_associations_by_code():
...
# Return definition sources for the specified terminology.
def test_get_definition_sources():
...
# Return metadata for definition type for the specified terminology and code.
def test_get_definition_type_by_code():
    logging.info("test_metadata_tests.py: Get Definition Types");
...
# Return metadata for synonym type for the specified terminology and code.
def test_get_synonym_type_by_code():
...
# Return all subsets (with minimal information) for a specified terminology
...
def test_get_subset_members_by_code():
    logging.info("test_metadata_tests.py: Get subset by code");
