...
from evs.api_response import ApiResponse, T as ApiResponseT
import evs.models
from evs import rest
from evs.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        if configuration is None:
            configuration = self.load_default_configs()
    ...
    @classmethod
    def load_default_configs(cls) -> Configuration:
        """ Set default Configuration params

        Pass the values we set in config.ini
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(evs.models, klass)
