...
class Terminology(BaseModel):
    ...
    graph: Optional[StrictStr] = Field(default=None,
                                       description="Name of the RDF triplestore graph if this data is backed by a "
                                                   "triplestore")
    terminology_version: Optional[StrictStr] = Field(default=None,
                                                     description="Underscore-separated value for terminology and "
                                                                 "version used by the API to precisely pinpoint a "
                                                                 "particular version, e.g. 'ncit_23.11d'",
