...
class StatisticsEntry(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["code", "key", "value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StatisticsEntry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StatisticsEntry from a dict"""
        if obj is None:
            return None
