...
class SearchCriteria(BaseModel):
    ...
    code_list: Optional[List[StrictStr]] = Field(default=None, description="Comma-separated list of concept codes to restrict search results by, e.g. 'C157225'", alias="codeList")
    ...
    __properties: ClassVar[List[str]] = ["uri", "ct", "term", "type", "include", "sort", "ascending", "fromRecord", "pageSize", "conceptStatus", "property", "value", "synonymSource", "synonymType", "definitionSource", "definitionType", "synonymTermType", "subset", "codeList", "terminology", "sparql"]
