...
class SearchCriteria(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None,
                                      description="The match type, one of: contains, match, startsWith, phrase, AND, "
                                                  "OR, fuzzy")
    include: Optional[StrictStr] = Field(default=None,
                                         description="Include parameter value, e.g. 'minimal', 'summary', 'synonyms,"
                                                     "properties,children'")
    sort: Optional[StrictStr] = Field(default=None, description="Sort field")
    ascending: Optional[StrictBool] = Field(default=None,
                                            description="Indicates whether sort is ascending (true), descending ("
                                                        "false), or not specified (null)")
    ...
    concept_status: Optional[List[StrictStr]] = Field(default=None,
                                                      description="Comma-separated list of concept status values to "
                                                                  "restrict search results by",
                                                      alias="conceptStatus")
    var_property: Optional[List[StrictStr]] = Field(default=None,
                                                    description="Comma-separated list of properties to restrict "
                                                                "search results by",
                                                    alias="property")
    ...
    synonym_source: Optional[List[StrictStr]] = Field(default=None,
                                                      description="Comma-separated list of synonym sources to "
                                                                  "restrict search results by",
                                                      alias="synonymSource")
    synonym_type: Optional[List[StrictStr]] = Field(default=None,
                                                    description="Comma-separated list of synonym types to restrict "
                                                                "search results by",
                                                    alias="synonymType")
    definition_source: Optional[List[StrictStr]] = Field(default=None,
                                                         description="Comma-separated list of definition sources to "
                                                                     "restrict search results by",
                                                         alias="definitionSource")
    definition_type: Optional[List[StrictStr]] = Field(default=None,
                                                       description="Comma-separated list of definition types to "
                                                                   "restrict search results by",
                                                       alias="definitionType")
    synonym_term_type: Optional[List[StrictStr]] = Field(default=None,
                                                         description="Comma-separated list of synonym term types to "
                                                                     "restrict search results by",
    ...
    subset: Optional[List[StrictStr]] = Field(default=None,
                                              description="Comma-separated list of subsets to restrict search results "
                                                          "by, e.g. 'C157225'")
    code_list: Optional[List[StrictStr]] = Field(default=None,
                                                 description="Comma-separated list of concept codes to restrict "
                                                             "search results by, e.g. 'C157225'",
                                                 alias="codeList")
    terminology: Optional[List[StrictStr]] = Field(default=None,
                                                   description="Comma-separated list of terminologies to search")
    sparql: Optional[StrictStr] = Field(default=None, description="SPARQL query, only available as an output parameter")
    __properties: ClassVar[List[str]] = ["uri", "ct", "term", "type", "include", "sort", "ascending", "fromRecord",
                                         ...
                                         "subset", "codeList", "terminology", "sparql"]
