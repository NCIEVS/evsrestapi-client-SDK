...
class Synonym(BaseModel):
    ...
    type_code: Optional[StrictStr] = Field(default=None, description="Synonym Type code", alias="typeCode")
    ...
    __properties: ClassVar[List[str]] = ["uri", "ct", "name", "highlight", "termType", "type", "typeCode", "source", "code", "subSource", "qualifiers", "active"]
