...
class Mapping(BaseModel):
    ...
    mapset_code: Optional[StrictStr] = Field(default=None, alias="mapsetCode")
    source: Optional[StrictStr] = Field(default=None, description="Terminology of the source code, e.g. 'ncit'")
    ...
    source_terminology: Optional[StrictStr] = Field(default=None, description="Human-readable label for the terminology of the source code, e.g. 'NCI Thesaurus'", alias="sourceTerminology")
    ...
    target: Optional[StrictStr] = Field(default=None, description="Terminology of the target code, e.g. 'ncit'")
    ...
    target_terminology: Optional[StrictStr] = Field(default=None, description="Human-readable label for the terminology of the target code, e.g. 'NCI Thesaurus'", alias="targetTerminology")
    ...
    __properties: ClassVar[List[str]] = ["uri", "ct", "mapsetCode", "source", "sourceName", "sourceTermType", "sourceCode", "sourceTerminology", "sourceTerminologyVersion", "sourceLoaded", "type", "rank", "group", "rule", "target", "targetName", "targetTermType", "targetCode", "targetTerminology", "targetTerminologyVersion", "targetLoaded", "sortKey", "targetTermGroup"]
