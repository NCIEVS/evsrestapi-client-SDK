...
class DisjointWith(BaseModel):
    ...
    code: Optional[StrictStr] = Field(default=None, description="Relationship code")
    ...
    group: Optional[StrictStr] = Field(default=None, description="Role group number for grouping related roles")
    ...
    __properties: ClassVar[List[str]] = ["uri", "ct", "code", "type", "relatedCode", "relatedName", "source", "group", "highlight", "qualifiers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DisjointWith from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DisjointWith from a dict"""
        if obj is None:
            return None
