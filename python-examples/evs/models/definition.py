...
class Definition(BaseModel):
    ...
    code: Optional[StrictStr] = Field(default=None, description="Definition code")
    ...
    __properties: ClassVar[List[str]] = ["uri", "ct", "definition", "highlight", "code", "type", "source", "qualifiers"]
