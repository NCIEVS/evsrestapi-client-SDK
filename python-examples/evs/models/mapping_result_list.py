...
class MappingResultList(BaseModel):
    """
    ...
    maps: Optional[List[Mapping]] = Field(default=None, description="List of maps")
    __properties: ClassVar[List[str]] = ["uri", "ct", "total", "timeTaken", "parameters", "maps"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MappingResultList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MappingResultList from a dict"""
        if obj is None:
            return None
