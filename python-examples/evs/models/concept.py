...
from evs.models.extensions import Extensions
...
class Concept(BaseModel):
    ...
    defining: Optional[StrictBool] = Field(default=None, description="Indicates whether the concept is defining")
    ...
    maps: Optional[List[Mapping]] = Field(default=None, description="Maps from this concept to concepts in other terminologies")
    paths: Optional[Paths] = None
    extensions: Optional[Extensions] = None
    __properties: ClassVar[List[str]] = ["uri", "ct", "code", "name", "terminology", "version", "level", "highlight", "subsetLink", "mapsetLink", "conceptStatus", "source", "leaf", "active", "defining", "synonyms", "definitions", "properties", "children", "parents", "descendants", "qualifiers", "associations", "inverseAssociations", "roles", "disjointWith", "inverseRoles", "history", "maps", "paths", "extensions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "maps": [Mapping.from_dict(_item) for _item in obj["maps"]] if obj.get("maps") is not None else None,
            "paths": Paths.from_dict(obj["paths"]) if obj.get("paths") is not None else None,
            "extensions": Extensions.from_dict(obj["extensions"]) if obj.get("extensions") is not None else None
        })
        return _obj
