...
class TerminologyMetadata(BaseModel):
    ...
    index_runtime: Optional[StrictInt] = Field(default=None, alias="indexRuntime")
    history_version: Optional[StrictStr] = Field(default=None, alias="historyVersion")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "indexRuntime": obj.get("indexRuntime"),
            "historyVersion": obj.get("historyVersion"),
