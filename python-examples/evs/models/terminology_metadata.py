...
class TerminologyMetadata(BaseModel):
    ...
    hierarchy_roles: Optional[List[StrictStr]] = Field(default=None,
                                                       description="Indicates role codes that are reinterpreted as "
                                                                   "parent/child",
                                                       alias="hierarchyRoles")
    ...
    __properties: ClassVar[List[str]] = ["uri", "ct", "uiLabel", "maxVersions", "loader", "conceptStatuses",
                                         "excludedProperties", "retiredStatusValue", "detailsColumns", "hierarchy",
                                         "hierarchyRoles", "history", "sourceCt", "subsetLink", "licenseText",
                                         "metaConceptField", "codeLabel", "welcomeText", "synonymTermGroup",
                                         "termGroups", "preferredTermGroups"]
