...
class MetadataEndpointsApi:
    ...
    def get_association(
        self,
        terminology: Annotated[StrictStr, Field(description="Terminology, e.g. 'ncit' or 'ncim' (<a href=\"https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/TERMINOLOGIES.md\">See here for complete list</a>)")],
    ...
    def get_overview_metadata(
        ...
        _param = self._get_overview_metadata_serialize(
            terminology=terminology,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_overview_metadata_with_http_info(
        self,
        terminology: Annotated[StrictStr, Field(description="Terminology, e.g. 'ncit' or 'ncim' (<a href=\"https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/TERMINOLOGIES.md\">See here for complete list</a>)")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Dict[str, List[Concept]]]:
        """Get some metadata (associations, properties, qualifiers, roles, term types, sources, definition types, synonym types) for the terminology overview tab in EVS-Explore
    ...
    @validate_call
    def get_overview_metadata_without_preload_content(
        self,
        terminology: Annotated[StrictStr, Field(description="Terminology, e.g. 'ncit' or 'ncim' (<a href=\"https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/TERMINOLOGIES.md\">See here for complete list</a>)")],
        _request_timeout: Union[
            None,
    ...
    def _get_overview_metadata_serialize(
        self,
        terminology,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/metadata/{terminology}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_property_values(
        self,
        terminology: Annotated[StrictStr, Field(description="Terminology, e.g. 'ncit' or 'ncim' (<a href=\"https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/TERMINOLOGIES.md\">See here for complete list</a>)")],
        code_or_name: Annotated[StrictStr, Field(description="Property code (or name), e.g.<ul><li>'P216' or 'BioCarta_ID' for <i>ncit</i></li><li>'Semantic_Type' for <i>ncim</i></li></ul>")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param terminology: Terminology, e.g. 'ncit' or 'ncim' (<a href=\"https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/TERMINOLOGIES.md\">See here for complete list</a>) (required)
        :type terminology: str
        :param code_or_name: Property code (or name), e.g.<ul><li>'P216' or 'BioCarta_ID' for <i>ncit</i></li><li>'Semantic_Type' for <i>ncim</i></li></ul> (required)
        :type code_or_name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _get_property_values_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/metadata/{terminology}/property/{codeOrName}/values',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_terminologies(
        ...
        terminology: Annotated[Optional[StrictStr], Field(description="Return entries with matching terminology, e.g. 'ncit' or 'ncim' (<a href=\"https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/TERMINOLOGIES.md\">See here for complete list</a>)")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
