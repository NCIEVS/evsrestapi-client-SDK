...
class MetadataEndpointsApi:
    ...
    def get_association(
            ...
            code_or_name: Annotated[StrictStr, Field(
                description="Association code (or name), e.g. <ul><li>'A10' or 'Has_CDRH_Parent' for "
                            "<i>ncit</i></li><li>'RB' or 'has a broader relationship' for <i>ncim</i></li></ul>")],
            include: Annotated[Optional[StrictStr], Field(
                description="Indicator of how much data to return. Comma-separated list of any of the following "
                            ...
                            "inverseAssociations, inverseRoles, maps, parents, properties, roles, synonyms. <a "
        ...
        :param code_or_name: Association code (or name), e.g. <ul><li>'A10' or 'Has_CDRH_Parent' for
        <i>ncit</i></li><li>'RB' or 'has a broader relationship' for <i>ncim</i></li></ul> (required)
        ...
        maps, parents, properties, roles, synonyms. <a
    ...
    def get_associations(
            ...
            list: Annotated[Optional[StrictStr], Field(
                description="List of codes or labels to return associations for (or leave blank for all). If invalid "
        ...
        for detailed information</a>.
        :type include: str
        :param list: List of codes or labels to return associations for (or leave blank for all). If invalid values
    ...
    def get_definition_type(
            ...
            terminology: Annotated[StrictStr, Field(
                description="Terminology, e.g. 'ncit' or 'ncim' (<a "
                            ...
                            "\">See here for complete list</a>)")],
            code_or_name: Annotated[StrictStr, Field(
                description="Definition type code (or name), e.g.<ul><li>'P325' or 'DEFINITION' for "
                            "<i>ncit</i></li><li>'DEFINITION' for <i>ncim</i></li></ul>")],
            include: Annotated[Optional[StrictStr], Field(
                description="Indicator of how much data to return. Comma-separated list of any of the following "
                            "values: minimal, summary, full, associations, children, definitions, disjointWith, "
                            "inverseAssociations, inverseRoles, maps, parents, properties, roles, synonyms. <a "
        ...
        complete list</a>) (required)
        :type terminology: str
        :param code_or_name: Definition type code (or name), e.g.<ul><li>'P325' or 'DEFINITION' for
        <i>ncit</i></li><li>'DEFINITION' for <i>ncim</i></li></ul> (required)
        :type code_or_name: str
        :param include: Indicator of how much data to return. Comma-separated list of any of the following values:
        minimal, summary, full, associations, children, definitions, disjointWith, inverseAssociations, inverseRoles,
        maps, parents, properties, roles, synonyms. <a
    ...
    def get_definition_types(
            ...
            include: Annotated[Optional[StrictStr], Field(
                description="Indicator of how much data to return. Comma-separated list of any of the following "
                            ...
                            "target='_blank'>See here for detailed information</a>.")] = None,
            list: Annotated[Optional[StrictStr], Field(
                description="List of codes or labels to return definition types for (or leave blank for all).  If "
                            "invalid values are passed, the result will simply include no entries for those invalid "
                            "values.")] = None,
            _request_timeout: Union[
                None,
                Annotated[StrictFloat, Field(gt=0)],
        ...
        for detailed information</a>.
        :type include: str
        :param list: List of codes or labels to return definition types for (or leave blank for all).  If invalid
    ...
    def get_properties(
            ...
            include: Annotated[Optional[StrictStr], Field(
                description="Indicator of how much data to return. Comma-separated list of any of the following "
                            ...
                            "target='_blank'>See here for detailed information</a>.")] = None,
            list: Annotated[Optional[StrictStr], Field(
                description="List of codes or labels to return properties for (or leave blank for all).  If invalid "
                            "values are passed, the result will simply include no entries for those invalid "
                            "values.")] = None,
            _request_timeout: Union[
                None,
        ...
        for detailed information</a>.
        :type include: str
        :param list: List of codes or labels to return properties for (or leave blank for all).  If invalid values
        are passed, the result will simply include no entries for those invalid values.
        :type list: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
    ...
    def get_property(
            ...
            terminology: Annotated[StrictStr, Field(
                description="Terminology, e.g. 'ncit' or 'ncim' (<a "
                            ...
                            "\">See here for complete list</a>)")],
            code_or_name: Annotated[StrictStr, Field(
                description="Property code (or name), e.g. <ul><li>'P216' or 'BioCarta_ID' for "
                            "<i>ncit</i></li><li>'BioCarta_ID' or ''BioCarta ID' for <i>ncim</i></li></ul>")],
            include: Annotated[Optional[StrictStr], Field(
                description="Indicator of how much data to return. Comma-separated list of any of the following "
                            "values: minimal, summary, full, associations, children, definitions, disjointWith, "
                            "inverseAssociations, inverseRoles, maps, parents, properties, roles, synonyms. <a "
        ...
        complete list</a>) (required)
        :type terminology: str
        :param code_or_name: Property code (or name), e.g. <ul><li>'P216' or 'BioCarta_ID' for
        <i>ncit</i></li><li>'BioCarta_ID' or ''BioCarta ID' for <i>ncim</i></li></ul> (required)
        :type code_or_name: str
        :param include: Indicator of how much data to return. Comma-separated list of any of the following values:
        minimal, summary, full, associations, children, definitions, disjointWith, inverseAssociations, inverseRoles,
        maps, parents, properties, roles, synonyms. <a
    ...
    def get_qualifier(
            ...
            terminology: Annotated[StrictStr, Field(
                description="Terminology, e.g. 'ncit' or 'ncim' (<a "
                            ...
                            "\">See here for complete list</a>)")],
            code_or_name: Annotated[StrictStr, Field(
                description="Qualifier code (or name), e.g.<ul><li>'P390' or 'go-source' for <i>ncit</i></li><li>'RG' "
                            "or 'Relationship group' for <i>ncim</i></li></ul>")],
            include: Annotated[Optional[StrictStr], Field(
                description="Indicator of how much data to return. Comma-separated list of any of the following "
                            "values: minimal, summary, full, associations, children, definitions, disjointWith, "
                            "inverseAssociations, inverseRoles, maps, parents, properties, roles, synonyms. <a "
        ...
        complete list</a>) (required)
        :type terminology: str
        :param code_or_name: Qualifier code (or name), e.g.<ul><li>'P390' or 'go-source' for <i>ncit</i></li><li>'RG'
        or 'Relationship group' for <i>ncim</i></li></ul> (required)
        :type code_or_name: str
        :param include: Indicator of how much data to return. Comma-separated list of any of the following values:
        minimal, summary, full, associations, children, definitions, disjointWith, inverseAssociations, inverseRoles,
        maps, parents, properties, roles, synonyms. <a
    ...
    def get_role(
            ...
            code_or_name: Annotated[StrictStr, Field(
                description="Role code (or name), e.g. 'R123' or 'Chemotherapy_Regimen_Has_Component' for "
        ...
        :type terminology: str
        :param code_or_name: Role code (or name), e.g. 'R123' or 'Chemotherapy_Regimen_Has_Component' for
        <i>ncit</i>. This call is only meaningful for <i>ncit</i>. (required)
        :type code_or_name: str
        :param include: Indicator of how much data to return. Comma-separated list of any of the following values:
        minimal, summary, full, associations, children, definitions, disjointWith, inverseAssociations, inverseRoles,
        maps, parents, properties, roles, synonyms. <a
    ...
    def get_roles(
            ...
            include: Annotated[Optional[StrictStr], Field(
                description="Indicator of how much data to return. Comma-separated list of any of the following "
                            ...
                            "target='_blank'>See here for detailed information</a>.")] = None,
            list: Annotated[Optional[StrictStr], Field(
                description="List of codes or labels to return roles for (or leave blank for all).  If invalid values "
                            "are passed, the result will simply include no entries for those invalid values.")] = None,
            _request_timeout: Union[
                None,
                Annotated[StrictFloat, Field(gt=0)],
                Tuple[
        ...
        for detailed information</a>.
        :type include: str
        :param list: List of codes or labels to return roles for (or leave blank for all).  If invalid values are
    ...
    def get_subset1(
            ...
            code: Annotated[StrictStr, Field(
                description="Subset code, e.g. 'C116978' for <i>ncit</i>. This call is only meaningful for "
                            "<i>ncit</i>.")],
            include: Annotated[Optional[StrictStr], Field(
                description="Indicator of how much data tc return. Comma-separated list of any of the following "
                            "values: minimal, summary, full, associations, children, definitions, disjointWith, "
                            "inverseAssociations, inverseRoles, maps, parents, properties, roles, synonyms. <a "
                            "href='https://github.com/NCIEVS/evsrestapi-client-SDK/blob/master/doc/INCLUDE.md' "
                            "target='_blank'>See here for detailed information</a>.")] = None,
        ...
        required)
        :type code: str
        :param include: Indicator of how much data tc return. Comma-separated list of any of the following values:
        minimal, summary, full, associations, children, definitions, disjointWith, inverseAssociations, inverseRoles,
        maps, parents, properties, roles, synonyms. <a
        href='https://github.com/NCIEVS/evsrestapi-client-SDK/blob/master/doc/INCLUDE.md' target='_blank'>See here
        for detailed information</a>.
    ...
    def get_subsets1(
            ...
            include: Annotated[Optional[StrictStr], Field(
                description="Indicator of how much data to return. Comma-separated list of any of the following "
                            ...
                            "target='_blank'>See here for detailed information</a>.")] = None,
            list: Annotated[Optional[StrictStr], Field(
                description="List of codes or labels to return subsets for (or leave blank for all).  If invalid "
                            "values are passed, the result will simply include no entries for those invalid "
                            "values.")] = None,
            _request_timeout: Union[
                None,
        ...
        for detailed information</a>.
        :type include: str
        :param list: List of codes or labels to return subsets for (or leave blank for all).  If invalid values are
        passed, the result will simply include no entries for those invalid values.
        :type list: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
    ...
    def get_synonym_type(
            ...
            terminology: Annotated[StrictStr, Field(
                description="Terminology, e.g. 'ncit' or 'ncim' (<a "
                            ...
                            "\">See here for complete list</a>)")],
            code_or_name: Annotated[StrictStr, Field(
                description="Synonym type code (or name), e.g.<ul><li>'P90' or 'FULL_SYN' for "
                            "<i>ncit</i></li><li>'Preferred_Name' or 'Preferred name' for <i>ncim</i></li></ul>")],
            include: Annotated[Optional[StrictStr], Field(
                description="Indicator of how much data to return. Comma-separated list of any of the following "
                            "values: minimal, summary, full, associations, children, definitions, disjointWith, "
                            "inverseAssociations, inverseRoles, maps, parents, properties, roles, synonyms. <a "
        ...
        complete list</a>) (required)
        :type terminology: str
        :param code_or_name: Synonym type code (or name), e.g.<ul><li>'P90' or 'FULL_SYN' for
        <i>ncit</i></li><li>'Preferred_Name' or 'Preferred name' for <i>ncim</i></li></ul> (required)
        :type code_or_name: str
        :param include: Indicator of how much data to return. Comma-separated list of any of the following values:
        minimal, summary, full, associations, children, definitions, disjointWith, inverseAssociations, inverseRoles,
        maps, parents, properties, roles, synonyms. <a
    ...
    def get_synonym_types(
            ...
            include: Annotated[Optional[StrictStr], Field(
                description="Indicator of how much data to return. Comma-separated list of any of the following "
                            ...
                            "target='_blank'>See here for detailed information</a>.")] = None,
            list: Annotated[Optional[StrictStr], Field(
                description="List of codes or labels to return synonym types for (or leave blank for all).  If "
                            "invalid values are passed, the result will simply include no entries for those invalid "
                            "values.")] = None,
            _request_timeout: Union[
                None,
        ...
        for detailed information</a>.
        :type include: str
        :param list: List of codes or labels to return synonym types for (or leave blank for all).  If invalid values
        are passed, the result will simply include no entries for those invalid values.
        :type list: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
    ...
    def get_terminologies(
            ...
            terminology: Annotated[Optional[StrictStr], Field(
                description="Return entries with matching terminology, e.g. 'ncit' or 'ncim' (<a "
                            "href=\"https://github.com/NCIEVS/evsrestapi-client-SDK/blob/master/doc/TERMINOLOGIES.md"
        ...
        :type tag: str
        :param terminology: Return entries with matching terminology, e.g. 'ncit' or 'ncim' (<a
        href=\"https://github.com/NCIEVS/evsrestapi-client-SDK/blob/master/doc/TERMINOLOGIES.md\">See here for
        complete list</a>)
        :type terminology: str
        :param _request_timeout: timeout setting for this request. If one
