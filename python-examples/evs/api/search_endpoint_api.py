...
"""
    ...
    The version of the OpenAPI document: 2.4.0.RELEASE
...
class SearchEndpointApi:
    ...
    def get_sparql_bindings(
        self,
        terminology: Annotated[StrictStr, Field(description="Single terminology to search, e.g. 'ncit' or 'ncim' (<a href=\"https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/TERMINOLOGIES.md\">See here for complete list</a>)")],
        body: Annotated[StrictStr, Field(description="SPARQL query to execute on the graph for the specified terminology. <a href='https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/SPARQL.md' target='_blank'>See here for more information and examples of using SPARQL with EVSRESTAPI</a>.")],
        ...
        prefixes: Annotated[Optional[StrictBool], Field(description="Use 'true' to use queries with declared prefixes")] = None,
        x_evsrestapi_license_key: Annotated[Optional[StrictStr], Field(description="Required license information for restricted terminologies. <a href='https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/LICENSE.md' target='_blank'>See here for detailed information</a>.")] = None,
        ...
        :type prefixes: bool
        :param x_evsrestapi_license_key: Required license information for restricted terminologies. <a href='https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/LICENSE.md' target='_blank'>See here for detailed information</a>.
    ...
    def get_sparql_prefixes(
        self,
        terminology: Annotated[StrictStr, Field(description="Single terminology to find prefixes for, e.g. 'ncit' or 'hgnc' (<a href=\"https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/TERMINOLOGIES.md\">See here for complete list</a>)")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_sparql_prefixes_serialize(
            terminology=terminology,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_sparql_prefixes_with_http_info(
        self,
        terminology: Annotated[StrictStr, Field(description="Single terminology to find prefixes for, e.g. 'ncit' or 'hgnc' (<a href=\"https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/TERMINOLOGIES.md\">See here for complete list</a>)")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_sparql_prefixes_without_preload_content(
        self,
        terminology: Annotated[StrictStr, Field(description="Single terminology to find prefixes for, e.g. 'ncit' or 'hgnc' (<a href=\"https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/TERMINOLOGIES.md\">See here for complete list</a>)")],
        _request_timeout: Union[
            None,
    ...
    def _get_sparql_prefixes_serialize(
        self,
        terminology,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/sparql/{terminology}/prefixes',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def search(
        self,
        x_evsrestapi_license_key: Annotated[Optional[StrictStr], Field(description="Required license information for restricted terminologies. <a href='https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/LICENSE.md' target='_blank'>See here for detailed information</a>.")] = None,
        terminology: Annotated[Optional[StrictStr], Field(description="Comma-separated list of terminologies to search, e.g. 'ncit' or 'ncim' (<a href=\"https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/TERMINOLOGIES.md\">See here for complete list</a>)")] = None,
    ...
    def search_single_terminology_sparql(
        self,
        terminology: Annotated[StrictStr, Field(description="Single terminology to search, e.g. 'ncit' or 'ncim' (<a href=\"https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/TERMINOLOGIES.md\">See here for complete list</a>)")],
        body: Annotated[StrictStr, Field(description="SPARQL query that returns ?code identifying a valid code in the specified terminology. <a href='https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/SPARQL.md' target='_blank'>See here for more information and examples of using SPARQL with EVSRESTAPI</a>.")],
        prefixes: Annotated[Optional[StrictBool], Field(description="Use 'true' to use queries with declared prefixes")] = None,
        x_evsrestapi_license_key: Annotated[Optional[StrictStr], Field(description="Required license information for restricted terminologies. <a href='https://github.com/NCIEVS/evsrestapi-client-SDK/blob/main/doc/LICENSE.md' target='_blank'>See here for detailed information</a>.")] = None,
        term: Annotated[Optional[StrictStr], Field(description="The term, phrase, or code to be searched, e.g. 'melanoma'")] = None,
        type: Annotated[Optional[StrictStr], Field(description="The match type, one of: contains, match, startsWith, phrase, AND, OR, fuzzy.")] = None,
