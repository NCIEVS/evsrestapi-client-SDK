...
class MapsetEndpointsApi:
    ...
    def get_mapset_by_code(
        ...
        """Get the mapset for the specified code (no terminology parameter is needed as mapsets connect codes in one
    ...
    def get_mapset_mappings_by_code(
        ...
        """Get the maps for the mapset specified by the code (no terminology parameter is needed as mapsets connect
