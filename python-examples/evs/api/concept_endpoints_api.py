...
class ConceptEndpointsApi:
    ...
    def get_association_entries(
        ...
        """Get the association entries for the specified terminology and code. Associations used to define subset
        membership are not resolved by this call


        :param terminology: Terminology, e.g. 'ncit' (required)
        :type terminology: str
        :param code_or_label: Code/label in the specified terminology, e.g. 'A5' or 'Has_Salt_Form' for <i>ncit</i>.
        This call is only meaningful for <i>ncit</i>. (required)
    ...
    def get_associations1(
            ...
            terminology: Annotated[StrictStr, Field(
                description="Terminology, e.g. 'ncit' or 'ncim' (<a "
        ...
        :param terminology: Terminology, e.g. 'ncit' or 'ncim' (<a
        href=\"https://github.com/NCIEVS/evsrestapi-client-SDK/blob/master/doc/TERMINOLOGIES.md\">See here for
        complete list</a>) (required)
        :type terminology: str
        :param code: Code in the specified terminology, e.g. <ul><li>'C3224' for <i>ncit</i></li><li>'C0025202' for
        <i>ncim</i></li></ul> (required)
        :type code: str
        :param x_evsrestapi_license_key: Required license information for restricted terminologies. <a
        href='https://github.com/NCIEVS/evsrestapi-client-SDK/blob/master/doc/LICENSE.md' target='_blank'>See here
        for detailed information</a>.
    ...
    def get_concept(
            ...
            limit: Annotated[Optional[StrictInt], Field(
                description="If set to an integer (between <i>1</i> and <i>100</i>), elements of the concept should "
                            "be limited to that specified number of entries. Thus a user interface can quickly "
                            "retrieve initial data for a concept (even with <i>include=full</i>) and then call back "
                            "for more data. An extra placeholder entry with just a <i>ct</i> field will be included "
                            "to indicate the total count.")] = None,
        ...
        <i>ncim</i></li></ul> (required)
        :type code: str
        :param limit: If set to an integer (between <i>1</i> and <i>100</i>), elements of the concept should be
        limited to that specified number of entries. Thus a user interface can quickly retrieve initial data for a
        concept (even with <i>include=full</i>) and then call back for more data. An extra placeholder entry with
    ...
    def get_concepts(
            ...
            list: Annotated[StrictStr, Field(
                description="List (comma-separated) of codes to return concepts for, e.g.<ul><li>'C2291,C3224' for "
                            "<i>ncit</i></li><li>'C0010137,C0025202' for <i>ncim</i></li></ul>")],
            include: Annotated[Optional[StrictStr], Field(
                description="Indicator of how much data to return. Comma-separated list of any of the following "
                            "values: minimal, summary, full, associations, children, definitions, disjointWith, "
                            "history, inverseAssociations, inverseRoles, maps, parents, properties, roles, "
        ...
        complete list</a>) (required)
        :type terminology: str
        :param list: List (comma-separated) of codes to return concepts for, e.g.<ul><li>'C2291,C3224' for
        <i>ncit</i></li><li>'C0010137,C0025202' for <i>ncim</i></li></ul> (required)
        :type list: str
        :param include: Indicator of how much data to return. Comma-separated list of any of the following values:
        minimal, summary, full, associations, children, definitions, disjointWith, history, inverseAssociations,
        inverseRoles, maps, parents, properties, roles, synonyms. <a
    ...
    def get_descendants(
            ...
            terminology: Annotated[StrictStr, Field(description="Terminology, e.g. 'ncit''")],
            code: Annotated[StrictStr, Field(
                description="Code in the specified terminology, e.g. 'C3224' for <i>ncit</i>. This call is only "
        ...
        :param terminology: Terminology, e.g. 'ncit'' (required)
        :type terminology: str
        :param code: Code in the specified terminology, e.g. 'C3224' for <i>ncit</i>. This call is only meaningful
        for <i>ncit</i>. (required)
        :type code: str
        :param from_record: Start index of the search results
        :type from_record: int
        :param page_size: Max number of results to return
    ...
    def get_disjoint_with(
            ...
            terminology: Annotated[StrictStr, Field(description="Terminology, e.g. 'ncit'")],
            code: Annotated[StrictStr, Field(
                description="Code in the specified terminology, e.g. 'C3910' for <i>ncit</i>.  This call is only "
                            "meaningful for <i>ncit</i>.")],
            x_evsrestapi_license_key: Annotated[Optional[StrictStr], Field(
                description="Required license information for restricted terminologies. <a "
                            "href='https://github.com/NCIEVS/evsrestapi-client-SDK/blob/master/doc/LICENSE.md' "
        ...
        :param terminology: Terminology, e.g. 'ncit' (required)
        :type terminology: str
        :param code: Code in the specified terminology, e.g. 'C3910' for <i>ncit</i>.  This call is only meaningful
        for <i>ncit</i>. (required)
        :type code: str
        :param x_evsrestapi_license_key: Required license information for restricted terminologies. <a
        href='https://github.com/NCIEVS/evsrestapi-client-SDK/blob/master/doc/LICENSE.md' target='_blank'>See here
    ...
    def get_history(
        ...
        :type terminology: str
        :param code: Code in the specified terminology, e.g. 'C3224' for <i>ncit</i>. This call is only meaningful
        for <i>ncit</i> and <i>ncim</i>. (required)
        :type code: str
        :param x_evsrestapi_license_key: Required license information for restricted terminologies. <a
        href='https://github.com/NCIEVS/evsrestapi-client-SDK/blob/master/doc/LICENSE.md' target='_blank'>See here
        for detailed information</a>.
    ...
    def get_paths_from_root(
            ...
            include: Annotated[Optional[StrictStr], Field(
                description="Indicator of how much data to return. Comma-separated list of any of the following "
                            ...
                            "history, inverseAssociations, inverseRoles, maps, parents, properties, roles, "
                            "synonyms. <a href='https://github.com/NCIEVS/evsrestapi-client-SDK/blob/master/doc"
                            "/INCLUDE.md' target='_blank'>See here for detailed information</a>. For this call, "
                            "it is recommended to avoid using this parameter unless you need it for a specific use "
                            "case.  Any value other than 'minimal' may produce very large payload results. ")] = None,
            from_record: Annotated[Optional[StrictInt], Field(description="Start index of the search results")] = None,
            page_size: Annotated[Optional[StrictInt], Field(description="Max number of results to return")] = None,
            x_evsrestapi_license_key: Annotated[Optional[StrictStr], Field(
                description="Required license information for restricted terminologies. <a "
        ...
        inverseRoles, maps, parents, properties, roles, synonyms. <a
        href='https://github.com/NCIEVS/evsrestapi-client-SDK/blob/master/doc/INCLUDE.md' target='_blank'>See here
        for detailed information</a>. For this call, it is recommended to avoid using this parameter unless you need
        it for a specific use case.  Any value other than 'minimal' may produce very large payload results.
        :type include: str
        :param from_record: Start index of the search results
        :type from_record: int
        :param page_size: Max number of results to return
    ...
    def get_paths_to_ancestor(
            ...
            ancestor_code: Annotated[StrictStr, Field(
                description="Ancestor code of the other specified code, e.g. 'C2991' for <i>ncit</i>. This call is "
                            "only meaningful for <i>ncit</i>.")],
            include: Annotated[Optional[StrictStr], Field(
                description="Indicator of how much data to return. Comma-separated list of any of the following "
                            "values: minimal, summary, full, associations, children, definitions, disjointWith, "
                            "history, inverseAssociations, inverseRoles, maps, parents, properties, roles, "
        ...
        for <i>ncit</i>. (required)
        :type code: str
        :param ancestor_code: Ancestor code of the other specified code, e.g. 'C2991' for <i>ncit</i>. This call is
        only meaningful for <i>ncit</i>. (required)
    ...
    def get_subset_members1(
            ...
            terminology: Annotated[StrictStr, Field(description="Terminology, e.g. 'ncit'")],
            code: Annotated[StrictStr, Field(
                description="Code for a subset concept in the specified terminology, e.g. 'C157225' for <i>ncit</i>. "
                            "This call is only meaningful for <i>ncit</i>.")],
            from_record: Annotated[Optional[StrictInt], Field(description="Start index of the search results")] = None,
            page_size: Annotated[Optional[StrictInt], Field(description="Max number of results to return")] = None,
            include: Annotated[Optional[StrictStr], Field(
        ...
        :param terminology: Terminology, e.g. 'ncit' (required)
        :type terminology: str
        :param code: Code for a subset concept in the specified terminology, e.g. 'C157225' for <i>ncit</i>. This
        call is only meaningful for <i>ncit</i>. (required)
        :type code: str
        :param from_record: Start index of the search results
        :type from_record: int
        :param page_size: Max number of results to return
    ...
    def get_subtree(
            ...
            code: Annotated[StrictStr, Field(
                description="Code in the specified terminology, e.g. 'C3224' for <i>ncit</i>. This call is only "
                            "meaningful for <i>ncit</i>.")],
            limit: Annotated[Optional[StrictInt], Field(
                description="If set to an integer (between <i>1</i> and <i>100</i>), subtrees and siblings at each "
                            "level will be limited to the specified number of entries. Thus a user interface can "
                            "quickly retrieve initial data for a subtree and then call back for more data. An extra "
                            "placeholder entry with just a <i>ct</i> field will be included to indicate the total "
                            "count.")] = None,
            x_evsrestapi_license_key: Annotated[Optional[StrictStr], Field(
                description="Required license information for restricted terminologies. <a "
                            "href='https://github.com/NCIEVS/evsrestapi-client-SDK/blob/master/doc/LICENSE.md' "
        ...
        for <i>ncit</i>. (required)
        :type code: str
        :param limit: If set to an integer (between <i>1</i> and <i>100</i>), subtrees and siblings at each level
        will be limited to the specified number of entries. Thus a user interface can quickly retrieve initial data
        for a subtree and then call back for more data. An extra placeholder entry with just a <i>ct</i> field will
    ...
    def get_subtree_children(
            ...
            code: Annotated[StrictStr, Field(
                description="Code in the specified terminology, e.g. 'C3224' for <i>ncit</i>. This call is only "
                            "meaningful for <i>ncit</i>.")],
            limit: Annotated[Optional[StrictInt], Field(
                description="If set to an integer (between <i>1</i> and <i>100</i>), children will be limited to the "
                            "specified number of entries. Thus a user interface can quickly retrieve initial data for "
                            "a subtree and then call back for more data. An extra placeholder entry with just a "
                            "<i>ct</i> field will be included to indicate the total count.")] = None,
            x_evsrestapi_license_key: Annotated[Optional[StrictStr], Field(
                description="Required license information for restricted terminologies. <a "
                            "href='https://github.com/NCIEVS/evsrestapi-client-SDK/blob/master/doc/LICENSE.md' "
                            "target='_blank'>See here for detailed information</a>.")] = None,
        ...
        for <i>ncit</i>. (required)
        :type code: str
        :param limit: If set to an integer (between <i>1</i> and <i>100</i>), children will be limited to the
        specified number of entries. Thus a user interface can quickly retrieve initial data for a subtree and then
        call back for more data. An extra placeholder entry with just a <i>ct</i> field will be included to indicate
        the total count.
        :type limit: int
        :param x_evsrestapi_license_key: Required license information for restricted terminologies. <a
        href='https://github.com/NCIEVS/evsrestapi-client-SDK/blob/master/doc/LICENSE.md' target='_blank'>See here
