...
func (o *Association) GetCode() string {
...
// and a boolean to check if the value has been set.
func (o *Association) GetCodeOk() (*string, bool) {
	if o == nil || IsNil(o.Code) {
		return nil, false
	}
	return o.Code, true
...
func (o *Association) HasCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *Association) SetCode(v string) {
	o.Code = &v
}
...
func (o *Association) GetGroup() string {
...
// and a boolean to check if the value has been set.
func (o *Association) GetGroupOk() (*string, bool) {
	if o == nil || IsNil(o.Group) {
		return nil, false
	}
	return o.Group, true
...
func (o *Association) HasGroup() bool {
	if o != nil && !IsNil(o.Group) {
		return true
	}
...
func (o *Association) SetGroup(v string) {
	o.Group = &v
}
