...
```bash
go test tests/<file name>
e.g. go test tests/applicationVersion_test.go
```

A specific test from a specific test script file can be run with this command:

```bash
go test tests/<file name> <test name>
e.g. go test tests/applicationVersion_test.go TestGetVersion
```

All tests can be run with the command 'go test tests/*'
